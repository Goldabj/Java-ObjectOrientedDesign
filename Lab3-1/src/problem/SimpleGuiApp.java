...
public class SimpleGuiApp {
	...
	public static void main(String[] args) throws Exception {
		...
		IRendererFactory rendererFactory = Configuration.getRendererFactory();
		...
		IRenderer windowRenderer = rendererFactory.createRenderer(window);
		IRenderer labelRenderer = rendererFactory.createRenderer(label);
		
		window.setRenderer(windowRenderer);
		label.setRenderer(labelRenderer);
		...
		IRenderer textRenderer = rendererFactory.createRenderer(text);
